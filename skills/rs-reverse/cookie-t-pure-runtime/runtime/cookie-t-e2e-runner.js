 ...
 *
 * 用法: node cookie-t-e2e-runner.js
 */
const crypto = require('crypto');
const http = require('http');
const fs = require('fs');
const path = require('path');
const { Coder, grenKeys } = require('./vm-coder.js');
const { buildBasearr } = require('./basearr-builder.js');
...
async function main() {
    ...
    const cacheFile = path.join(__dirname, '../samples/mainjs-sample.js');
    let mainjs;
