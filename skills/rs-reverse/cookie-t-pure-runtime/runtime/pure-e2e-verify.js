...
const { Coder } = require('./vm-coder.js');
const { buildBasearr, crc32, numToNumarr4, ascii2string } = require('./basearr-builder.js');
...
async function main() {
    ...
    const mainjs = fs.readFileSync(path.join(__dirname, '../samples/mainjs-sample.js'), 'utf-8');
    ...
    // Step 4: 生成 basearr
    const { grenKeys } = require('./vm-coder.js');
