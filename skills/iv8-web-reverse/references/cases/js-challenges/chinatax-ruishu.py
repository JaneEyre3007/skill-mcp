...
environment = {
    "location": {
        "ancestorOrigins": {},
        "href": "http://chongqing.chinatax.gov.cn:8888/qxzfgs/wz/xzcf/swxzybcxcfjg",
        "origin": "http://chongqing.chinatax.gov.cn:8888",
        "protocol": "http:",
        "host": "chongqing.chinatax.gov.cn:8888",
        "hostname": "chongqing.chinatax.gov.cn",
        "port": "8888",
        "pathname": "/qxzfgs/wz/xzcf/swxzybcxcfjg",
        "search": "",
        "hash": ""
    },
    "navigator": {
...
url = "http://chongqing.chinatax.gov.cn:8888/api/loadNewsInfo"
...
headers = {
    ...
    "Origin": "http://chongqing.chinatax.gov.cn:8888",
    "Pragma": "no-cache",
    "Referer": "http://chongqing.chinatax.gov.cn:8888/qxzfgs/wz/xzcf/swxzybcxcfjg",
...
with iv8.JSContext(environment=environment, config={"timezone": "Asia/Shanghai"}) as ctx:
    ...
    js_code2 = requests.get(js_url2, headers={**headers, "Cookie": cookies_str}).text
    ...
    response = requests.post(api_url, data=body_str, headers={**headers, "Cookie": final_cookie}, cookies=cookie_header_to_dict(final_cookie))
