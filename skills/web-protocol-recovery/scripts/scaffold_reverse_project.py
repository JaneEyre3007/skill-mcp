...
PROJECT_DIRS = [
    ...
    "input",
    "js_reverse_cache",
    "js_reverse_cache/fonts",
    "js_reverse_cache/html",
    "js_reverse_cache/network",
    "js_reverse_cache/screenshots",
    "js_reverse_cache/scripts",
    "js_reverse_cache/state",
    "js_reverse_cache/traces",
    "js_reverse_cache/wasm",
    "logs",
    "output",
    "tests",
]
...
def analysis_templates() -> dict[str, str]:
    return {
        ...
        """,
        "input/.gitkeep": "",
        "js_reverse_cache/README.md": """
            # js_reverse_cache

            Store reconnaissance-only artifacts here:

            - downloaded JavaScript, WASM, fonts, and HTML
            - network exports, request/response bodies, and CDP snapshots
            - browser state snapshots, screenshots, traces, and runtime probes
            - temporary throwaway scripts used while proving the protocol

            Stable protocol code belongs in `collector/`.
            Curated proof notes and fixed vectors belong in `analysis/`.
        """,
        "logs/.gitkeep": "",
        "output/.gitkeep": "",
        "requirements.txt": """
