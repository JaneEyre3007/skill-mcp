...
Reconnaissance artifacts stay inside this project tree under root-level `js_reverse_cache/`. Stable protocol code belongs in `collector/`; curated proof notes and fixed vectors belong in `analysis/`.
