/**
  * @env-module web-crypto-stub
 * @description Web Crypto API模拟
 * @compatibility Chrome 80+, Firefox 75+, Edge 79+
 */

(function() {
    const profile = window.__ProfileManager__ ? window.__ProfileManager__.getSection('crypto') : {};
    let seed = profile.randomSeed !== undefined ? profile.randomSeed : null;
