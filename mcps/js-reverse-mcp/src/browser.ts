...
// cloakBinaryPath). These take precedence over CLI args and allow switching
// between normal Chrome and CloakBrowser at runtime without restarting MCP.
...
export function getRuntimeLaunchOverrides(): RuntimeLaunchOverrides | undefined {
