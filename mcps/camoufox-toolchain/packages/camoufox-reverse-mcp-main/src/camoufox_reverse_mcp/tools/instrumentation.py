        ...
        async def route_handler(route):  # type: ignore[no-untyped-def]  # Route object
            try:
                ...
                try:
                    ...
                    stats["last_continue_error"] = str(continue_error)
        ...
        if url_pattern is not None:
            if url_pattern in _active_routes:
                ...
                try:
                    ...
                    removed.append({"pattern": url_pattern, "unroute_error": str(e)})
        ...
        if clear_log:
            try:
                await page.evaluate("""() => {
                    ...
                    if (window.__mcp_vmp_log) window.__mcp_vmp_log.length = 0;
