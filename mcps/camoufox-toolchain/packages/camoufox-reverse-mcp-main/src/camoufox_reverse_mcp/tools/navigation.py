...
async def launch_browser(
    ...
    Args:
        ...
        maximize: Maximize the browser window (headful only, default False).
        window_width/window_height: Fixed outer window size.
        viewport_width/viewport_height: Fixed Playwright viewport size.
        no_viewport: Let viewport follow the real browser window.
