 ...
 */
const MOD = (name) => `resource:///modules/agentsidebar/${name}.sys.mjs`;
/**
...
const [tid] = arguments;
const { agentSession } = ChromeUtils.importESModule(${JSON.stringify(MOD("AgentSession"))});
const wasRunning = agentSession.isRunning(tid);
agentSession.stop(tid);
return { ok:true, stopped:true, wasRunning };
`;
/**
...
`;
//# sourceMappingURL=chromeScripts.js.map